...
const NavBar = () => {
    ...
    return (
        <div>
            <nav className="navbar navbar-expand-lg nvarbar-light gb-white py-3">
                <div className="container">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div className='buttons'>
                            ...
                            <NavLink to="/singin" className="btn btn-outline-dark ms-2">
                                <i className="fa-solid fa-right-to-bracket"></i>Singin</NavLink>
